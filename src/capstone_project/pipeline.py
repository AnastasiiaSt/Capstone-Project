...
def preprocess(dataset: pd.DataFrame, variance_threshold: bool, threshold: int, scaling: bool, pca: bool, n_components: int) -> Tuple[pd.DataFrame, dict]: 
    ...
    if variance_threshold:
        num_pipeline_steps.append(('variance_threshold', VarianceThreshold(threshold = threshold)))
